...
let handler = async (m, { conn, text, usedPrefix, command }) => {  
  if (!text) return m.reply(`${emoji} Por favor ingresa el nombre del paquete NPM y la versión (opcional).`);  
  ...
  try {  
    ...
    m.reply('Parece que ocurrió un error o el paquete no fue encontrado');  
  }  
};  
