const handler = async (m, { conn, text, isROwner }) => {
  ...
  const mensajeFinal = `*📣 Comunicado del Administrador*\n\n${mensaje}\n\n⭐️ Gracias por estar aquí.\n\nℹ️ Nota: Este mensaje fue enviado por el administrador de este bot. No oficial del 𝗞𝗜𝗡𝗚•𝗕𝗢𝗧.\n\n🔗 *Canal oficial:* https://whatsapp.com/channel/0029VbC7MPJ59PwTYKZlgf10`;
