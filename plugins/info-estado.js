...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  const wm = '𝗜𝗡𝗧𝗘𝗥•𝗞𝗜𝗡𝗚 - 𝗞𝗜𝗡𝗚•𝗕𝗢𝗧';

  const info = `╭━━〔 *${tradutor.texto1[0]}* 〕━━⬣
┃👑 *${tradutor.texto1[1]}* INTER•KING
┃📞 *${tradutor.texto1[2]}* wa.me/5493765142705
┃📢 *Canal:* https://whatsapp.com/channel/0029VbC7MPJ59PwTYKZlgf10
