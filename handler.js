...
m.reply(`《✦》Estás bloqueado, no puedes usar comandos en este bot.!\n\n${user.bannedReason ? `✰ *Rason:* ${user.bannedReason}` : '✰ *Rason:* Not Specified'}\n\n> ✧ Si este Bot es una cuenta oficial y tienes pruebas de que este mensaje es un error, puedes presentar tu caso a un moderador.`)
return
}
...
conn.reply(m.chat, `❮✦❯ Te as quedado sin ${moneda}`, m)
continue
}
...
owner: `『✦』El comando *${comando}* solo puede ser usado por desarrollador.`,
mods: `『✦』El comando  *${comando}* solo puede ser usado por los moderadores del bot.`,
premium: `『✦』El comando *${comando}* solo puede ser usado por usuarios premium.`,
group: `『✦』El comando *${comando}* solo puede ser usado en grupos.`,
private: `『✦』El.comando *${comando}* solo puede ser usado en el chat privado del bot.`,
admin: `『✦』El comando *${comando}* solo puede ser usado por los administradores del grupo.`,
botAdmin: `『✦』Pra ejecutar el comando *${comando}* devo ser administrador.`,
unreg: `『✦』El comando *${comando}* solo puede ser usado por usuarios registrados. Registrate usando:\n> » #${randomVerify} ${user2}.${randomAge}`,
